...
if (isProduction) {
  // For Supabase connection, use the non-SSL approach
  // Extract connection components from URL instead of using connectionString
  ...
  poolConfig = connectionInfo;
  console.log('Using production database connection without SSL');
} else {
